...
class Dense {
    ...
    init(unitsNum: Int, inputsNum: Int = 0, useBias: Bool = true, dataType: DType = DType.float32) {
        ...
        print("exited dense init")
        
    }
    
    func setOptimizer(optimizer: Optimizer) {
        
        print("entered dense setOptimizer")
        
        self.optimizer = optimizer
        
        print("exited dense setOptimizer")
        
    }
    
    func build() {
        
        print("entered dense build")
    ...
    func setGrads(grads: (MLXArray, MLXArray)) {
        ...
        print("entered dense setGrads")
        
        (self.gradW, self.gradB) = grads
        
        print("exited dense setGrads")
